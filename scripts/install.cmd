@echo off
:: ============================================
:: RV There Yet Head Tracking - Install
:: ============================================
...
:: Pass, whose exe directories are Ride\Binaries\Win64 and Ride\Binaries\WinGDK,
:: where a shared body resolves one game path and deploys there. It also plants
:: %SystemRoot%\System32\dxgi.dll as dxgi_orig.dll for the proxy to forward to,
:: which is not a backup of anything the game shipped and has no equivalent in the
:: shared shim body.
